...
delivered_table_spec = 'bigquery-demo-335405:dataset_food_orders.delivered_orders'

#project-id:dataset_id.table_id
other_table_spec = 'bigquery-demo-335405:dataset_food_orders.other_status_orders'
...
view_to_create.view_query = 'select * from `bigquery-demo-335405.dataset_food_orders_latest.delivered_orders` where _PARTITIONDATE = DATE(current_date())'
